trigger CaseTrigger on Case (before insert, after insert, before update, after update) {
    ...
    if (Trigger.isInsert && Trigger.isBefore) {
        ...
        cu_CaseForTicketsTriggerHandler.bookingTypeField_update(Trigger.New, new Map<Id, Case>());
        cu_CaseForTicketsTriggerHandler.caseSubject_update(Trigger.New);
        cu_CaseForTicketsTriggerHandler.jorneyTypeField_update(Trigger.New, new Map<Id, Case>());
        cu_CaseForTicketsTriggerHandler.typeOfAssistance_update(Trigger.New, new Map<Id, Case>());
    }
    ...
    if (Trigger.isUpdate && Trigger.isBefore) {
        ...
        cu_CaseForTicketsTriggerHandler.classOfServiceFields_update(Trigger.New);
        cu_CaseForTicketsTriggerHandler.bookingTypeField_update(Trigger.New, Trigger.oldMap);
        cu_CaseForTicketsTriggerHandler.jorneyTypeField_update(Trigger.New, Trigger.oldMap);
        cu_CaseForTicketsTriggerHandler.typeOfAssistance_update(Trigger.New, Trigger.oldMap);
